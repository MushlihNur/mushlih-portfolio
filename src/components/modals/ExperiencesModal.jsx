...
function ExperiencesModal() {
  return (
    <ModalSection title="Experiences">
      <div className="flex flex-row flex-wrap justify-start gap-3 sm:gap-6 lg:gap-6 xl:gap-10 w-full p-4">
        {[...experiencesData].reverse().map((experience) => (
          <div key={experience.id} className="flex items-start justify-start gap-3 bg-[#FFFFFF] rounded-2xl p-4 w-full lg:w-[320px] h-fit shadow-[0_0_16px_rgba(0,0,0,0.15)]">
